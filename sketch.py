...
class Window(QMainWindow):
    def __init__(self):
        ...
        def useEraser(self):
            ...
            self.imageArea.brushColor = Qt.white  
            self.imageArea.brushSize = self.brush_thickness.value()  

        def setsketch(self):
            
            self.sketch_box.mousePressEvent = self.switchToPencil 

        def switchToPencil(self, event):
         
            self.changeDrawMode(self.pointAction)  
        ...
        self.setGeometry(100, 100, 1100, 800)  # top, left, width, height
    ...
    def setBrushJoin(self):
        ...
        self.brush_join_type.setMaximumHeight(105)
    ...
    def usePencil(self):
        ...
        self.imageArea.brushColor = Qt.black
        self.imageArea.brushSize = self.brush_thickness.value() 
        self.styleBtn1.clicked.connect(lambda: self.changeBrushStyle(self.styleBtn1))
    ...
    def setsketch(self):
        self.sketch_box = QGroupBox("sketch")
        self.sketch_box.setMaximumHeight(70)  

        self.sketch_button = QPushButton()  # Create a QToolButton instead of QPushButton
        self.sketch_button.setStyleSheet("background-color: none; border: none; padding: 100px; margin: 0px;")
        self.sketch_button.setIcon(QIcon("./icons/pencil.png"))  # Set the icon
        self.sketch_button.setIconSize(QSize(31, 31))  # Set the icon size
        self.sketch_button.setToolTip("sketch")  # Set tooltip text
        self.sketch_button.clicked.connect(self.usePencil)

        layout = QVBoxLayout()
        layout.addWidget(self.sketch_button)
        self.sketch_box.setLayout(layout)
        self.box.vbox.addWidget(self.sketch_box)
    ...
    def setEraser(self):
        self.eraser_group_box = QGroupBox("Eraser")
        self.eraser_group_box.setMaximumHeight(63)  

        self.eraser_button = QPushButton() 
        self.eraser_button.setStyleSheet("background-color: none; border: none; padding: px; margin: 0px;")
        self.eraser_button.setIcon(QIcon("./icons/eraser.png"))  
        self.eraser_button.setIconSize(QSize(37, 37)) 
        self.eraser_button.setToolTip("Use Eraser")  
        self.eraser_button.clicked.connect(self.useEraser)
            
        layout = QVBoxLayout()
        layout.addWidget(self.eraser_button)
        self.eraser_group_box.setLayout(layout)

        self.box.vbox.addWidget(self.eraser_group_box)
    ...
    def setBrushSlider(self):
        self.groupBoxSlider = QGroupBox("Size")
    ...
    def setColorChanger(self):
        ...
        self.brush_colour.setStyleSheet("background-color: none; border: none; padding: 0px; margin: 0px;")
        self.box.vbox.addWidget(self.brush_colour)
        self.brush_colour.setIcon(QIcon("icons\color_chooser.png")) 
        self.brush_colour.setIconSize(QSize(100, 100))
    ...
    def help(self):
        ...
        msg.setText("Help"
                    ...
                    "you can send an email to sketchy@gmail.com</p> ")
        msg.setWindowTitle("Help")
        msg.move(int(self.width() / 2), int(self.height() / 2))
        msg.exec_()
